...
//! use crypto::utils::serialization::fixed::{FDeserializable, FSerializable};
//! use crypto::utils::serialization::variable::{VDeserializable, VSerializable};
//! // The macro is exported by the crypto crate at its root
//! use crypto::VSerializable as VSer;
//!
