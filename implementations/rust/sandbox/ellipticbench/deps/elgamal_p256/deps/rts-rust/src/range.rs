...
//
pub fn from_to_usize<T: Literal>(len: T::Length, from: usize, to: usize) -> impl Stream<T> {
...
pub fn from_to_by_usize<T: Literal>(
    ...
    (from..=to)
        .step_by(step)
        .map(move |x| <T>::number_usize(len.clone(), x))
}
...
pub fn from_to_inf_uint<T: Literal>(len: T::Length, from: num::BigUint) -> impl Stream<T> {
    FromToInf {
        current: from,
        step: 1u8.into(),
    }
...
pub fn inf_from<T: Integral>(len: T::Length, start: T::Arg<'_>) -> impl Stream<T> {
    InfFromThen {
...
mod test {
    ...
    fn test_from_then_to_usize() {
        assert_eq!(
            from_then_to_usize::<DWord>(8, 1, 3, 8).to_vec(),
            [
                DWord::from_u32(8, 1),
                DWord::from_u32(8, 3),
                DWord::from_u32(8, 5),
        ...
        assert_eq!(
            from_then_to_usize::<DWord>(8, 1, 3, 5).to_vec(),
            [
                DWord::from_u32(8, 1),
                DWord::from_u32(8, 3),
                DWord::from_u32(8, 5)
        ...
        assert_eq!(
            from_then_to_usize::<DWord>(8, 1, 3, 6).to_vec(),
            [
                DWord::from_u32(8, 1),
                DWord::from_u32(8, 3),
                DWord::from_u32(8, 5)
        ...
        assert_eq!(
            from_then_to_usize::<DWord>(8, 1, 3, 3).to_vec(),
            [DWord::from_u32(8, 1), DWord::from_u32(8, 3)]
        );
        assert_eq!(
            from_then_to_usize::<DWord>(8, 1, 3, 1).to_vec(),
            [DWord::from_u32(8, 1)]
        );
        assert_eq!(
            from_then_to_usize::<DWord>(8, 5, 3, 1).to_vec(),
            [
                DWord::from_u32(8, 5),
                DWord::from_u32(8, 3),
                DWord::from_u32(8, 1)
