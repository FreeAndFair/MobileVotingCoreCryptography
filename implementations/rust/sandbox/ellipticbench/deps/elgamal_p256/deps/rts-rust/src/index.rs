...
pub(crate) fn front_index<I: Integral>(x: I::Arg<'_>) -> usize {
    I::to_usize(x)
}
...
pub(crate) fn back_index<I: Integral>(len: usize, x: I::Arg<'_>) -> usize {
    ...
    assert!(
        n < len,
        "Index {} is too large for sequence with {} elements",
        n,
        len
    );
    len - 1 - n
...
pub fn index_stream_back<T, I>(len: usize, xs: impl Stream<T>, i: I::Arg<'_>) -> T
where
    T: Type,
    I: Integral,
{
